...
class Profile extends MY_Controller {
	...
	public function index() {
        $this->dataModule['results']= $this->Sitefunction->get_single_row(TBL_STORE_OWNERS, '*', array('id'=>$this->user_id));
        ...
        if($postData && !empty($postData)) {
			...
			if ($this->form_validation->run() != FALSE)
			{
                ...
                if($this->Sitefunction->update(TBL_STORE_OWNERS, $data_array, array('id'=>$this->user_id))){
    ...
    public function change_password(){
        ...
        if($postData && !empty($postData)) {
			...
			if ($this->form_validation->run() != FALSE)
			{
                ...
                $check_password= $this->Sitefunction->get_single_row(TBL_STORE_OWNERS, '*', array('password'=>md5($old_password)));
