                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li class="active"><?=$this->lang->line('store_details')?></li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card alert">
                            ...
                            <div class="row">
                                ...
                                <?php foreach($categories as $cats) { ?>
                                    <div class="card-header">
                                    <h2 style="color:#0a9822"><center><?=$cats['title']?></center></h2>
                                </div>
                                ...
                                <?php
                                     ...
                                     $join = array();
                                     $group_by = '';
                                     $subcategory=  $this->Sitefunction->get_all_rows(TBL_STORE_SUBCATEGORIES, $columns, $where, $join, array(), '', '', array(), $group_by, array(), array());
