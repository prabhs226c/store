                            ...
                            <div class="bootstrap-data-table-panel">
                                ...
                                <tbody>
                                        ...
                                        if (!empty($results)) {
                                            ...
                                            <td>&nbsp;&nbsp;<a class="fa fa-eye" data-toggle="tooltip" style="color: #00c0ef;" title="View Details!" href="<?=STORES_PATH?>/view/<?=$single['id']?>"></a>&nbsp;&nbsp;
                                            <a href="<?=STORES_PATH?>/invoice/<?=$single['id']?>" class="fa fa-file" style="color:green" data-toggle="tooltip" title="View Invoice"></a></td>
                                            </tr>
                                            <?php
...
<script type="text/javascript">
	...
	$.ajax({
		type:"POST",
		url:"<?=STORES_PATH?>/change_availablity",
