                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card alert">
                            ...
                            <div class="pull-right">
                                <a class="btn btn-success btn-flat m-b-10 m-l-5" style="margin-right:15px!important" href="<?=STORE_SUBCATEGORY_PATH?>/add"><?=$this->lang->line('add_subcategory')?></a>
                                <input class="btn btn-danger  btn-flat m-b-10 m-l-5" style="margin-left:-14px!important" type="submit" onclick="multiple_delete('<?=STORE_SUBCATEGORY_PATH?>/multiple_delete')" id="postme" value="<?=$this->lang->line('delete')?>" disabled="disabled">
