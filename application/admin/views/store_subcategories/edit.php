                        ...
                        <div class="card alert">
                            ...
                            <div class="card-body">
                                <div class="menu-upload-form">
                                    ...
                                    <form class="form-horizontal" action="<?= STORE_SUBCATEGORY_PATH ?>/edit/<?= $results->id ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data" id="addSubcategory">
                                    <div class="row">
                                            <div class="col-md-6">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <select class="form-control required" name="restaurant_id" id="restaurant_id">
                                                            ...
                                                            foreach ($restaurants as $row) { ?>
                                                                <option <?= $row['id'] == $results->id ? 'selected' : '' ?> value="<?= $row['id']; ?>"><?= urldecode($row['name']); ?></option>
                                                            <?php } ?>
                                                        </select>
