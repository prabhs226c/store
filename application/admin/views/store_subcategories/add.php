                ...
                <div class="col-lg-8 p-0">
                    <div class="page-header">
                        <div class="page-title">
                            <h1><?=$this->lang->line('store_subcategories')?></h1>
                        </div>
                    </div>
                </div><!-- /# column -->
                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li><a href="<? STORE_SUBCATEGORY_PATH ?>"><?=$this->lang->line('subcategory_list')?></a></li>
                        ...
                        <div class="card alert">
                            ...
                            <div class="card-body">
                                <div class="menu-upload-form">
                                    ...
                                    <form class="form-horizontal" action="<?= STORE_SUBCATEGORY_PATH ?>/add" method="post" accept-charset="utf-8" enctype="multipart/form-data" id="addSubcategory">

                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label"><?=$this->lang->line('store')?>:</label>
                                                    <div class="col-sm-8">
                                                        <select class="form-control required" name="restaurant_id" id="restaurant_id">

                                                            <option value=""><?=$this->lang->line('select_store')?></option>
                                                            <?php
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<select class="form-control required" name="type" id="type">
															...
															<option  value="1"><?=$this->lang->line('per_kg')?></option>
															<option  value="2"><?=$this->lang->line('per_lbs')?></option>
															<option  value="3"><?=$this->lang->line('per_unit')?></option>
															<option  value="4"><?=$this->lang->line('per_dozen')?></option>
