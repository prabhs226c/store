                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li><a href="<?= STORE_OWNER_PATH ?>"><?=$this->lang->line('store_owner_list')?></a></li>
                        ...
                        <div class="card alert">
                            ...
                            <div class="card-body">
                                <div class="menu-upload-form">
                                    ...
                                    <form class="form-horizontal" action="<?= STORE_OWNER_PATH ?>/add" method="post" accept-charset="utf-8" id="addOwner">
                                        <div class="row">
                                            <div class="col-md-6">
