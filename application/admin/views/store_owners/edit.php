                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li><a href="<?=STORE_OWNER_PATH ?>"><?=$this->lang->line('owner_list')?></a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card alert">
                            ...
                            <div class="card-body">
                                ...
                                <form class="form-horizontal" action="<?= STORE_OWNER_PATH ?>/edit/<?=$results->id?>" method="post" accept-charset="utf-8" id="addOwner">
                                        <div class="row">
                                            <div class="col-md-6">
