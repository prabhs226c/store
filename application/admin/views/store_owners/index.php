                ...
                <div class="col-lg-8 p-0">
                    <div class="page-header">
                        <div class="page-title">
                            <h1><?=$this->lang->line('store_owners')?></h1>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card alert">
                            ...
                            <div class="pull-right">
                                <a class="btn btn-success btn-flat m-b-10 m-l-5" style="margin-right:15px!important" href="<?=STORE_OWNER_PATH?>/add"><?=$this->lang->line('add_owner')?></a>
                                <input class="btn btn-danger btn-flat m-b-10 m-l-5" type="submit" onclick="multiple_delete('<?=STORE_OWNER_PATH?>/multiple_delete')" id="postme" value="<?=$this->lang->line('delete')?>" disabled="disabled">
                            ...
                            <div class="bootstrap-data-table-panel">
                                ...
                                <tbody>
                                        ...
                                        if (!empty($results)) {
                                            ...
                                            <td>&nbsp;&nbsp;<a class="ti-pencil-alt" data-toggle="tooltip" style="color: #00c0ef;" title="<?=$this->lang->line('edit')?>!" href="<?=STORE_OWNER_PATH?>/edit/<?=$single['id']?>"></a>&nbsp;&nbsp;<a href="javascript:void(0)" class="ti-trash" style="color:red" data-toggle="tooltip" title="<?=$this->lang->line('delete')?>!" onclick="delete_status('<?=STORE_OWNER_PATH?>/delete', '<?=$single['id']?>')"></a>&nbsp;&nbsp</td>
                                            </tr>
                                            <?php
