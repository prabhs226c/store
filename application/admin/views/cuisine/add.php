                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li><a class="active" href="javascript:void(0)"><?= $this->lang->line('add_cuisine') ?></a></li>
                        ...
                        <div class="card alert">
                            ...
                            <div class="card-body">
                                <div class="menu-upload-form">
                                    ...
                                    <form class="form-horizontal" action="<?= CUISINE_PATH ?>/add" method="post" accept-charset="utf-8" id="addCuisine" enctype="multipart/form-data">
