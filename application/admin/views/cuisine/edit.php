                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li><a href="<?= CUISINE_PATH ?>"><?= $this->lang->line('cuisine_list') ?></a></li>
                                <li><a class="active" href="javascript:void(0)"><?= $this->lang->line('edit_cuisine') ?></a></li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /# column -->
                        ...
                        <div class="card alert">
                            ...
                            <div class="card-body">
                                <div class="menu-upload-form">
                                    ...
                                    <form class="form-horizontal" action="<?= CUISINE_PATH ?>/edit/<?= $results->id; ?>" method="post" accept-charset="utf-8" id="editCuisine" enctype="multipart/form-data">
