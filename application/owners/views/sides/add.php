                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li><a href="javascrit:void(0)" class="active"><?=$this->lang->line('add_sides')?></a></li>
                        ...
                        <div class="card alert">
                            ...
                            <div class="card-body">
                                <div class="menu-upload-form">
                                    ...
                                    <form class="form-horizontal" action="<?= SIDES_PATH ?>/add" method="post" accept-charset="utf-8" enctype="multipart/form-data" id="addSides">
