                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li><a href="javascrit:void(0)" class="active"><?=$this->lang->line('edit_addon')?></a></li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /# column -->
                        ...
                        <div class="card alert">
                            ...
                            <div class="card-body">
                                <div class="menu-upload-form">
                                    ...
                                    <form class="form-horizontal" action="<?= ADDON_PATH ?>/edit/<?= $results->id ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data" id="addAddon">
                                    <div class="row">
                                            <div class="col-md-6">
