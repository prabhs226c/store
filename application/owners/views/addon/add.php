                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li><a href="<? ADDON_PATH ?>"><?=$this->lang->line('addon_list')?></a></li>
                                <li><a href="javascrit:void(0)" class="active"><?=$this->lang->line('add_addon')?></a></li>
                        ...
                        <div class="card alert">
                            ...
                            <div class="card-body">
                                <div class="menu-upload-form">
                                    ...
                                    <form class="form-horizontal" action="<?= ADDON_PATH ?>/add" method="post" accept-charset="utf-8" enctype="multipart/form-data" id="addAddon">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <select class="form-control required" name="subcategory_id" id="subcatergory_id">

                                                            <option value=""><?=$this->lang->line('select_subcategory')?></option>
                                                            <?php
                                                            foreach ($foodcategory as $row) { ?>
                                                                <option <?= $row['id'] == set_value('subcategory_id') ? 'selected' : '' ?> value="<?= $row['id']; ?>"><?= urldecode($row['title']); ?></option>
                                                            <?php } ?>
                                                        </select>
                                                        <?= form_error('addon_id'); ?>
                                                    </div>
